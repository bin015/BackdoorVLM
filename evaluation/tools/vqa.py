...
class VQA:
    ...
    def loadRes(self, resFile, quesFile):
        """
        Load result file or result data and return a result object.
        :param resFile (str or list): file name of result file OR loaded results
        :param quesFile (str): question file path
